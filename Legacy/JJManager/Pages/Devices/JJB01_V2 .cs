...
namespace JJManager.Pages.Devices
{
    public partial class JJB01_V2 : MaterialForm
    {
        ...
        public JJB01_V2(MaterialForm parent, JJDeviceClass device)
        {
            InitializeComponent();
            ...
            FlpJJB01V2.SuspendLayout();
            FlpJJB01V2.Controls.Clear();
            FlpJJB01V2.Controls.Add(TxtGeneralConfigs);
            FlpJJB01V2.Controls.Add(materialDivider3);
            FlpJJB01V2.Controls.Add(cmdBoxLedMode);
            FlpJJB01V2.Controls.Add(SldLedBrightness);
            FlpJJB01V2.Controls.Add(SldPulseSpeed);
            FlpJJB01V2.Controls.Add(SldBlinkSpeed);
            FlpJJB01V2.Controls.Add(TxtProperties);
            FlpJJB01V2.Controls.Add(PropertiesDivider);
            FlpJJB01V2.Controls.Add(dgvActions);
            FlpJJB01V2.Controls.Add(BtnAddLedAction);
            FlpJJB01V2.ResumeLayout(true);
...
*/
        ...
        private void ReorganizeFlowLayoutPanel()
        {
            ...
            if (FlpJJB01V2.Controls.Contains(TxtGeneralConfigs)) FlpJJB01V2.Controls.SetChildIndex(TxtGeneralConfigs, 0);
            if (FlpJJB01V2.Controls.Contains(materialDivider3)) FlpJJB01V2.Controls.SetChildIndex(materialDivider3, 1);
            if (FlpJJB01V2.Controls.Contains(cmdBoxLedMode)) FlpJJB01V2.Controls.SetChildIndex(cmdBoxLedMode, 2);
            if (FlpJJB01V2.Controls.Contains(SldLedBrightness)) FlpJJB01V2.Controls.SetChildIndex(SldLedBrightness, 3);
            if (FlpJJB01V2.Controls.Contains(SldPulseSpeed)) FlpJJB01V2.Controls.SetChildIndex(SldPulseSpeed, 4);
            if (FlpJJB01V2.Controls.Contains(SldBlinkSpeed)) FlpJJB01V2.Controls.SetChildIndex(SldBlinkSpeed, 5);
            if (FlpJJB01V2.Controls.Contains(TxtProperties)) FlpJJB01V2.Controls.SetChildIndex(TxtProperties, 6);
            if (FlpJJB01V2.Controls.Contains(PropertiesDivider)) FlpJJB01V2.Controls.SetChildIndex(PropertiesDivider, 7);
            if (FlpJJB01V2.Controls.Contains(dgvActions)) FlpJJB01V2.Controls.SetChildIndex(dgvActions, 8);
            if (FlpJJB01V2.Controls.Contains(BtnAddLedAction)) FlpJJB01V2.Controls.SetChildIndex(BtnAddLedAction, 9);
        }
