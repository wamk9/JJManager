...
{
    internal class JJB999 : HIDClass, IDisposable
    {
        ...
        public (bool, bool) SendData(bool acceptedOldVersionPlugin)
        {
            ...
            if (led_mode_value == 4)
            {
                ...
                {
                    _simHubSync.TranslateToButtonBoxHID(message, out messageToSend, "jjb999", ref acceptedOldVersionPlugin, brightness_limit_value);
                }
            }
            else
            {
