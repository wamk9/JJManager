...
{
    public partial class LedRgbAction : MaterialForm
    {
        ...
        public LedRgbAction(MaterialForm parent, Leds ledToEdit, int ledSelected)
        {
            InitializeComponent();
            ...
            PnlColor.BackColor = _materialSkinManager.CardsColor;

            FillForm();
            SetRoundedCorners(PnlColor, 100);
            SetEvents();
        }
        ...
        public void SetEvents()
        {
            ...
            #region GeneralForms
            ClrEditor.ColorChanged += ClrEditor_ColorChanged;
        ...
        private void ClrEditor_ColorChanged(object sender, EventArgs e)
        {
            PnlColor.BackColor = ClrEditor.Color;
        }
        ...
        public void UpdateForm()
        {
            ...
            ClrEditor.Color = ColorTranslator.FromHtml(LedToSave?.Color ?? "#000000");
            PnlColor.BackColor = ClrEditor.Color;
        ...
        private void Save()
        {
            ...
            string color = $"#{ClrEditor.Color.R:X2}{ClrEditor.Color.G:X2}{ClrEditor.Color.B:X2}";
            ...
            //{
            //    _device.Profile.Outputs[_ledSelected].SetToLeds(Leds.LedType.PWM);
            //}
